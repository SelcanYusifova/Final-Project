...
function Flatwareanddinnerwareadmin () {
  ...
  const fetchData = () => {
    fetch("http://localhost:3000/allProducts")
      ...
      .then((allProducts) => {
        ...
        if (kitchenCategory && kitchenCategory.products.flatwareanddinnerware) {
  ...
  useEffect(() => {
    ...
    const handleProductAdded = (event) => {
      console.log("productAdded event:", event.detail);
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold mb-6">Kitchen and dining - Flatware and dinnerware</h2>
...
export default Flatwareanddinnerwareadmin;
