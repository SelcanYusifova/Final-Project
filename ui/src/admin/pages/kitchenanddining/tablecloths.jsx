...
function Tableclothsadmin () {
  ...
  const fetchData = () => {
    fetch("http://localhost:3000/allProducts")
      ...
      .then((allProducts) => {
        ...
        if (kitchenCategory && kitchenCategory.products.tablecloths) {
          setData(kitchenCategory.products.tablecloths);
        }
      })
      .catch((error) => {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold mb-6">Kitchen and dining - Tablecloths</h2>
...
export default Tableclothsadmin;
