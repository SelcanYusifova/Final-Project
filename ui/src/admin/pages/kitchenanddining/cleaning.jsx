...
function Cleaningadmin() {
  ...
  const fetchData = () => {
    fetch("http://localhost:3000/allProducts")
      ...
      .then((allProducts) => {
        ...
        if (kitchenCategory && kitchenCategory.products.cleaning) {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold mb-6">Kitchen and dining - Cleaning</h2>
