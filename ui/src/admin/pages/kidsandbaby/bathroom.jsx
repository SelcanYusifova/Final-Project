...
function Bathroomadmin () {
  ...
  const fetchData = () => {
    fetch("http://localhost:3000/allProducts")
      ...
      .then((allProducts) => {
        ...
        if (babyCategory && babyCategory.products.bathroom) {
          setData(babyCategory.products.bathroom);
        }
      })
      .catch((error) => {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold mb-6">Kids and baby - Bathroom</h2>
