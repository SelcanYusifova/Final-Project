...
function   Babyadmin() {
  ...
  const fetchData = () => {
    fetch("http://localhost:3000/allProducts")
      ...
      .then((allProducts) => {
        ...
        if (babyCategory && babyCategory.products.baby) {
          setData(babyCategory.products.baby);
        }
      })
      .catch((error) => {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold mb-6">Kids and baby - Baby</h2>
