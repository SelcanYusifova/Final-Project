...
function Cushionsandthrowsadmin() {
  ...
  const fetchData = () => {
    fetch("http://localhost:3000/allProducts")
      ...
      .then((allProducts) => {
        ...
        if (bedroomCategory && bedroomCategory.products.bedroomcushionandthrows) {
          setData(bedroomCategory.products.bedroomcushionandthrows);
        }
      })
      .catch((error) => {
  ...
  useEffect(() => {
    ...
    const handleProductAdded = (event) => {
      ...
      if (mappedSubcategory === "bedroomcushionandthrows") {
        setData(prevData => {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold mb-6">Bedroom - Cushions and throws</h2>
...
export default Cushionsandthrowsadmin; 
